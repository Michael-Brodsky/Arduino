...
template<class T> 
struct std_is_const : std_false_type {};

template<class T> 
struct std_is_const<const T> : std_true_type {};
...
template <class T> 
struct std_is_reference : std_false_type {};

template <class T> 
struct std_is_reference<T&> : std_true_type {};
...
//
//	template <class T>
//	auto try_add_pointer(int)->type_identity<typename std_remove_reference<T>::type*> {};
//	template <class T>
...
//////// two types
//template <class T1, class T2>
//using std_cond_t = decltype(false ? declval<T1>() : declval<T2>());
